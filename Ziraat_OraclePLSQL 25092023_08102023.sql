...
/*
"Oracle veritabanýndaki 'hr' þemasýndaki 'employees' adlý 
mevcut bir tabloyu temel alarak, ayný verilere sahip yeni 
bir 'employees' adlý tabloyu oluþturun."
*/
...
/*
"Oracle veritabanýndaki 'employees' adlý tablodan, her bir çalýþanýn 
'employee_id' (çalýþan kimlik numarasý), 'first_name' (adý), 
'last_name' (soyadý) ve 'salary' (maaþ) sütunlarýný seçin."
*/
...
/*
"Oracle veritabanýndaki 'employees' adlý tablodan, 'job_id' (iþ kimliði) sütunu 'IT_PROG' olarak 
eþleþen çalýþanlarýn 'employee_id' (çalýþan kimlik numarasý), 'first_name' (adý), 'last_name' (soyadý), 
'salary' (maaþ) ve 'job_id' (iþ kimliði) sütunlarýný seçin."
*/
...
/*
"Oracle veritabanýndaki 'employees' adlý tablodan, iþ kimliði 'IT_PROG' ve 
maaþý 5000'den büyük olan çalýþanlarýn 'employee_id' (çalýþan kimlik numarasý), 
'first_name' (adý), 'last_name' (soyadý), 'salary' (maaþ) ve 'job_id' (iþ kimliði) sütunlarýný seçin."
*/
...
/*
"Oracle veritabanýndaki 'employees' adlý tablodaki çalýþanlarýn
'job_id' (iþ kimliði) ile gruplandýrýldýðýnda, her iþ kimliði için
toplam maaþý hesaplayýn ve sonucu 'ToplamSalary' olarak adlandýrýn."
...
/*
"Oracle veritabanýndaki 'employees' adlý tablodaki çalýþanlarýn 
'job_id' (iþ kimliði) ile gruplandýrýldýðýnda, her iþ kimliði için maaþlarýn toplamýný 
hesaplayýn, 'ToplamSalary' olarak adlandýrýn ve bu toplamý 10.000'den büyük olan gruplarý bulun."
*/
...
/*
"Oracle veritabanýndaki 'employees' adlý tablodaki çalýþanlarýn iþ kimlikleri ('job_id') ile 
gruplandýrýldýðýnda, her bir iþ kimliði için maaþlarýn toplamýný hesaplayýn, 'ToplamSalary
olarak adlandýrýn ve bu toplamý 10.000'den büyük olan gruplarý bulduktan sonra, 
bu gruplarý toplam maaþa göre büyükten küçüðe ve küçükten büyüðe sýralayýn."
*/
...
/*
"Oracle veritabanýndaki 'employees' adlý tablodan, 'department_id' (departman kimliði) 
60, 80 veya 90 olan çalýþanlarýn iþ kimlikleri ('job_id') ile gruplandýrýldýðýnda, her bir iþ kimliði için 
maaþlarýn toplamýný 'TotalSalary' olarak adlandýrýn ve bu toplamý 30.000'den büyük olan gruplarý 
bulduktan sonra, bu gruplarý toplam maaþa göre büyükten küçüðe sýralayýn."
*/
...
/*
"Oracle veritabanýndaki 'employees' adlý tablodan, 'department_id' 
(departman kimliði) deðeri 60 olan çalýþanlarýn tüm bilgilerini seçin."
*/
...
/*
"Oracle veritabanýndaki 'employees' adlý tablodan, 'department_id' deðeri
60, 70 veya 80 olan çalýþanlarýn tüm bilgilerini seçin."
*/
...
/*
"Oracle veritabanýndaki 'employees' adlý tablodan, 'department_id' deðeri 
60, 70 veya 80 olan çalýþanlarýn 'employee_id' (çalýþan kimlik numarasý), 
'first_name' (adý), 'last_name' (soyadý) ve 'Salary' (maaþ) sütunlarýný seçin."
*/
...
"Oracle veritabanýndaki 'employees' adlý tablodan, 'department_id' deðeri
60, 70 veya 80 olan çalýþanlarýn 'employee_id' (çalýþan kimlik numarasý),
'first_name' (adý), 'last_name' (soyadý) ve 'Salary' (maaþ) sütunlarýný seçin ve 
maaþa göre büyükten küçüðe sýralayýn."
*/
...
"Oracle veritabanýndaki 'employees' adlý tablodan, 'department_id' deðeri 
60, 70 veya 80 olan çalýþanlarýn 'employee_id' (çalýþan kimlik numarasý), 
'Salary' (maaþ), 'first_name' (adý) ve 'last_name' (soyadý) sütunlarýný seçin 
ve 4. sütuna göre (salary) büyükten küçüðe sýralayýn."
*/
...
------------------------------------------------------------------------------------------------------------------------
/*
"Oracle veritabanýndaki 'employees' adlý tabloyla 'departments' adlý tabloyu 
'department_id' (departman kimliði) alaný üzerinden birleþtirin, 
böylece her çalýþanýn ilgili departman bilgilerini içeren bir sonuç kümesi oluþturun."
*/
...
/*
"Oracle veritabanýndaki 'employees' adlý tabloyla 'departments' adlý tabloyu
'department_id' (departman kimliði) alaný üzerinden birleþtirerek her çalýþanýn 
'employee_id' (çalýþan kimlik numarasý), 'first_name' (adý), 'last_name' (soyadý) ve 
ilgili departmanýn adýný içeren bir sonuç kümesi oluþturun."
*/
...
/*
"Oracle veritabanýndaki 'employees' adlý tabloyla 'departments' adlý tabloyu 
'department_id' (departman kimliði) alaný üzerinden, 'locations' adlý tabloyu 
'location_id' (konum kimliði) alaný üzerinden, 'countries' adlý tabloyu 
'country_id' (ülke kimliði) alaný üzerinden ve 'regions' adlý tabloyu
'region_id' (bölge kimliði) alaný üzerinden birleþtirerek her çalýþanýn 
'employee_id' (çalýþan kimlik numarasý), 'first_name' (adý), 'last_name' (soyadý), 
'job_id' (iþ kimliði), 'salary' (maaþ), ilgili departmanýn adý, konumun posta kodu, 
þehir, eyalet/ilçe, ülke adý ve bölge adýný içeren bir sonuç kümesi oluþturun."
*/
...
'location_id' (konum kimliði) alaný üzerinden, 'countries' adlý tabloyu 
'country_id' (ülke kimliði) alaný üzerinden ve 'regions' adlý tabloyu
'region_id' (bölge kimliði) alaný üzerinden birleþtirerek her bölge için
maaþlarýn toplamýný hesaplayýn ve sonucu 'TotalSalary' olarak adlandýrýn."
*/
...
'location_id' (konum kimliði) alaný üzerinden, 'countries' adlý tabloyu 
'country_id' (ülke kimliði) alaný üzerinden ve 'regions' adlý tabloyu 
'region_id' (bölge kimliði) alaný üzerinden birleþtirerek her bölge ve ülke için 
maaþlarýn toplamýný hesaplayýn ve sonucu 'TotalSalary' olarak adlandýrýn. 
Sonuçlarý bölge ve ülke adlarýna göre gruplandýrýn ve buna göre sýralayýn."
*/
...
'location_id' (konum kimliði) alaný üzerinden, 'countries' adlý tabloyu 
'country_id' (ülke kimliði) alaný üzerinden ve 'regions' adlý tabloyu 
'region_id' (bölge kimliði) alaný üzerinden birleþtirerek 
her bölge, ülke ve eyalet/ilçe için maaþlarýn toplamýný hesaplayýn. 
Sonucu 'TotalSalary' olarak adlandýrýn ve sonuçlarý bölge adý, ülke adý ve eyalet/ilçe 
adý sýrasýna göre gruplayarak ve bu sýralamaya göre sýralayarak gösterin."
*/
...
"Oracle veritabanýndaki 'employees' adlý tabloyla 'departments' adlý tabloyu 
'department_id' (departman kimliði) alaný üzerinden, 'locations' adlý tabloyu 
'location_id' (konum kimliði) ve 'country_id' (ülke kimliði) alanlarý üzerinden, 
'countries' adlý tabloyu 'country_id' alaný üzerinden ve 'regions' adlý tabloyu 
'region_id' (bölge kimliði) alaný üzerinden birleþtirerek her bölge, ülke, 
eyalet/ilçe, þehir ve departman için maaþlarýn toplamýný hesaplayýn. 
Sonucu 'TotalSalary' olarak adlandýrýn ve sonuçlarý bölge adý, ülke adý, e
yalet/ilçe adý, þehir adý ve departman adý sýrasýna göre gruplayarak ve 
bu sýralamaya göre sýralayarak gösterin."
...
-- Yukaridaki tablolari join edelim
Select
        --c.custid,
        c.companyname,
        --e.empid,
...
-- Yukaridaki sorguda companyname'lere alias verelim
...
/*
"Oracle veritabanýnda 'vw_Rapor' adlý yeni bir görünüm (view) oluþturun.
Bu görünüm, satýþ sipariþleri, müþteriler, çalýþanlar, sipariþ detaylarý, ürünler, 
kategoriler, tedarikçiler ve nakliyecilerle ilgili verileri içerir ve bu verileri farklý
tablolardan çekerek müþteri adý, çalýþan adý, sipariþ tarihi, navlun ücreti, ürün birim fiyatý, 
miktar, ürün adý, kategori adý, tedarikçi adý ve nakliyeci adý gibi sütunlarda sunar."
*/
...
/*
"Görünüm 'vw_Rapor' içindeki çalýþanlarýn adlarýna göre navlun ücretlerinin
toplamýný hesaplayýn ve sonucu 'Totalfreight' olarak adlandýrarak gruplayýn."
*/
...
/*
"Görünüm 'vw_Rapor' içindeki kategori adlarýna göre navlun ücretlerinin 
toplamýný hesaplayýn ve sonucu 'Totalfreight' olarak adlandýrarak gruplayýn."
*/
...
/*
"Görünüm 'vw_Rapor' içindeki kategori ve ürün adlarýna göre navlun ücretlerinin
toplamýný hesaplayýn ve sonucu 'Totalfreight' olarak adlandýrarak kategori ve ürün 
adlarýna göre gruplandýrýn, ardýndan bu sýralamaya göre sýralayýn."
*/
...
"Görünüm 'vw_Rapor' içindeki kategori ve ürün adlarýna göre navlun ücretlerinin 
toplamýný hesaplayýn ve sonucu 'Totalfreight' olarak adlandýrarak kategori ve ürün 
adlarýna göre gruplandýrýn, ardýndan sýralamayý kategori ve ürün adlarýna göre yapýn."
*/
Select
        categoryname,
        productname,
...
"Görünüm 'vw_Rapor' içindeki kategori ve ürün adlarýna göre navlun ücretlerinin 
toplamýný hesaplayýn ve sonucu 'Totalfreight' olarak adlandýrarak kategori ve ürün 
adlarýna göre gruplandýrýn, ardýndan sýralamayý kategori ve ürün adlarýna göre azalan þekilde yapýn."
*/
...
"Görünüm 'vw_Rapor' içindeki kategori ve ürün adlarýna göre navlun ücretlerinin 
toplamýný hesaplayýn ve sonucu 'Totalfreight' olarak adlandýrarak kategori ve ürün 
adlarýna göre gruplandýrýn, ardýndan sýralamayý toplam navlun ücretine göre azalan þekilde yapýn."
*/
...
/*
"Görünüm 'vw_Rapor' içindeki ürün kategori adlarýna ve ürün adlarýna göre navlun ücretlerinin 
toplamýný hesaplayýn, sonucu 'Totalfreight' olarak adlandýrarak kategori ve ürün 
adlarýna göre gruplandýrýn ve toplam navlun ücretlerine göre azalan sýrada sýralayýn."
*/
...
/*
"Görünüm 'vw_Rapor' içindeki ürün kategori adlarýna göre navlun ücretlerinin 
toplamýný hesaplayýn, sonucu 'TotalFreight' olarak adlandýrarak kategori adlarýna göre gruplandýrýn."
*/
...
SELECT TO_DATE('15-10-2023', 'DD-MM-YYYY') AS converted_date FROM DUAL;
SELECT TO_DATE('15-10-2023 14:30:00', 'DD-MM-YYYY HH24:MI:SS') AS converted_datetime FROM DUAL;

SELECT TO_CHAR(TO_DATE('15-10-2023', 'DD-MM-YYYY') + 7, 'DD-MON-YYYY') AS new_date FROM DUAL;


/*
"Görünüm 'vw_Rapor' içindeki sipariþ tarihleri, çalýþan adlarý, 
soyadlarý, sipariþ yýllarý ve navlun ücretlerini görüntüleyin."
*/
...
/*
"Görünüm 'vw_Rapor' içindeki sipariþ yýllarýna göre navlun ücretlerinin 
toplamýný hesaplayýn, sonucu 'TotalFreight' olarak adlandýrarak 
sipariþ yýllarýna göre gruplandýrýn ve yýllara göre sýralayýn."
*/
...
/*
WITH (Common Table Expressions - Ortak Tablo Ýfadeleri)
*/
