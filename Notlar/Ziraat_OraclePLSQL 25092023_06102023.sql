...
JOIN hr_employes he ON so.empid = he.empid-- Tablo isimleri ve join koþulu varsayýlmýþtýr. 
...
-- Ornek1
-- Sales_Orders tablosunda herbir orderid'nin yanýna önceki order'idyi yazdýran sorgu
Select
            o1.orderid,
            (
...
-- Ornek 2
-- Sales_Orders tablosunda herbir orderid'nin yanýna sonraki orderid'yi yazýnýz.
...
-- Ornek 3
-- Yýllara göre toplam qty'leri bulnuz ve view haline getiriniz.
-- Tarih alaný olarak orderdate kullan
